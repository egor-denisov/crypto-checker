...
import { getCoinsOutMassiv, getCountOfPages } from '../utils/sortingAndSearchingCoins';
...
const AddingAlert = ({setVisible}: {setVisible: Function}) => {
    const [pagination, setPagination] = useState({page: 0, limit: 5, countOfPages: getCountOfPages(5, coins.size)})
    ...
    const {typeOfSorting, setTypeOfSorting, 
           ...
           massivOfCoins} = useTrackerCoinTable(getCoinsOutMassiv(rates, data.washlist), pagination, setPagination, data, loading)
    return (
