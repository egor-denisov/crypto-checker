...
const RowOfTableOfCoins = ({
	...
	const [activeWashlist, setActiveWashlist] = useState(
		!washlist.includes(name)
	)
	...
	useEffect(
		() => setActiveWashlist(!activeWashlist),
		[washlist.includes(name)]
	)
	useEffect(
		() => setActiveWallet(!activeWallet),
		[wallet_keys.includes(name)]
	)
	return (
		<>
			{vizibleWalletAlert && (
