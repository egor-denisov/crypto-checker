import { WalletMenuAction, WalletMenuActionTypes, WalletMenu } from "../../types/walletMenuTypes"

const initialContexWalletMenu: WalletMenu = {
    vizibleContexMenu: false,
    vizibleDropdownMenu: false
}
export const WalletMenuReducer = (state = initialContexWalletMenu, action: WalletMenuAction) => {
    switch (action.type){
