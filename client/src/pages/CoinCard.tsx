...
const CoinCard = () => {
    ...
    const {name, symbol, MarketInfo, loading} = useTypedSelector(state => state.coinInfo)
    ...
    return (
        <div className='coin-card'>
            ...
            <div className='rate-and-char'>
                <Rate name={name} change={change} rate={rate} currency='USD' numberAfterPoint={getCoinPoints(name)} checkChanges={true}/>
                <div className="characteristics">
                    <div className="char market-cap">
                        <p className="value">${zerozAfterPoint(marketCap/1000000000, 3)}B</p>
                        <p className="name">MARKET CAP</p>
                    </div>
                    <div className="char market-cap-fd">
                        <p className="value">${zerozAfterPoint(fdmarketCap/1000000000, 3)}B</p>
                        <p className="name">FD MARKET CAP</p>
                    </div>
                    <div className="char trading-volume">
                        <p className="value">${zerozAfterPoint(totalVolume/1000000000, 3)}B</p>
                        <p className="name">TOTAL VOLUME</p>
                    </div>
                    <div className="char market-cap">
                        {circulatatingSupply>1000000000-1
                            ? <p className="value">${zerozAfterPoint(circulatatingSupply/1000000000, 3)}B</p>
                            : <p className="value">${zerozAfterPoint(circulatatingSupply/1000000, 3)}M</p>
                        }
                        <p className="name">CIRCULATING SUPPLY</p>
                    </div>
                    <div className="char market-cap">
                        {circulatatingSupply>1000000000-1
                            ? <p className="value">${zerozAfterPoint(maxSupply/1000000000, 3)}B</p>
                            : <p className="value">${zerozAfterPoint(maxSupply/1000000, 3)}M</p>
                        }
